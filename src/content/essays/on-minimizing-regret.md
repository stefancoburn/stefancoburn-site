...
1. Write the more interesting story.
2. Lean into fear, uncertainty, and doubt.
3. Regret from action is less painful than regret from inaction.
...
1. Taking an action, seeing it turn out badly, and regretting what followed.
2. Staying the course, making no new decision, and living with the lingering regret of "what if."
